...
import { EnvelopeSimpleIcon, LinkedinLogoIcon, XLogoIcon } from "@phosphor-icons/react/dist/ssr"
        ...
        <div className=' col-span-12 border-1 border-[#222222]  px-3 py-8'>
            ...
            <Image src={author1} alt="Meet the mind behind The Grinder — hustler, coder, and creator Ahmed Ashraf El-Gendy." width={150} height={500} className="  object-cover rounded-[50%]" />
              ...
              <div className="flex flex-col md:flex-row  items-center ms-auto gap-10 me-3 ">
                    ...
                    <Link href={`mailto:ahmedashrafelgendy25@gmail.com?subject=Hello&body=Hi%20there!`}>
